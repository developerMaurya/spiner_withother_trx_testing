...
import spinerController from '../controllers/spinerController';
...
const initWebRouter = (app) => {
    ...
    router.get('/api/webapi/use/userpromotionDetails', userController.getUserDetails);
    ...
    router.get('/wallet/tron', middlewareController, homeController.tronrechargePage);
    router.post('/api/webapi/tronrecharge', middlewareController, userController.tronrecharge);
    ...
    router.post('/api/webapi/addUsdt', middlewareController, userController.addUsdt);
...
router.get('/wallet/usdtwithdrawal', middlewareController, homeController.usdtwithdrawalPage);
router.get('/wallet/addusdt', middlewareController, homeController.addUsdt);
    ...
    router.post('/api/webapi/usdtwithdrawal', middlewareController, userController.withdrawal4); 
...
router.get('/trx/30', middlewareController, winGoController.trxwingoPage3);
...
router.post('/api/webapi/GetMyEmerdListtrx', middlewareController, winGoController.trxGetMyEmerdList);
router.post('/api/webapi/action/jointrx', middlewareController, winGoController.trxbetWinGo);
router.post('/api/webapi/GetNoaverageEmerdListtrx', middlewareController, winGoController.trxlistOrderOld);

// trx admin
router.get('/admin/manager/trxindex', adminController.middlewareAdminController, adminController.trxadminPage);

// spiner 
router.get('/spiner', middlewareController, spinerController.spinerPage);
router.post('/spin', middlewareController, spinerController.spinAction);

router.get('/admin/manager/Changepassword', adminController.middlewareAdminController, adminController.adminChangePassword);
    router.get('/admin/manager/addGift', adminController.middlewareAdminController, adminController.addGift);
    router.post('/admin/manager/updatepassword', adminController.middlewareAdminController, adminController.adminUpdatePassword);
    router.post('/admin/manage/updateAmount', adminController.updateUserMoney);
