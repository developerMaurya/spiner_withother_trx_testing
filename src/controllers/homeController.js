...
const usdtwithdrawalPage = async (req, res) => {
    return res.render("wallet/usdtwithdrawal.ejs");
}
...
const addUsdt = async (req, res) => {
    return res.render("wallet/addusdt.ejs");
}
// promotion
...
const tronrechargePage = async (req, res) => {
    return res.render("wallet/tron.ejs", {
        MinimumMoney: process.env.TRON_MINIMUM_MONEY
    });
}
